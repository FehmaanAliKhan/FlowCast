    ...
    <Card hover className="p-5" onClick={onEdit}>
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-slate-800 dark:text-slate-100 text-sm">{scenario.name}</span>
          {scenario.isBaseline && (
            <span className="text-xs bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400 px-2 py-0.5 rounded-full">Baseline</span>
          )}
        </div>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="font-mono text-sm font-semibold text-slate-800 dark:text-slate-100">{Money.format(endBal)}</p>
        </div>
        {delta !== null && (
